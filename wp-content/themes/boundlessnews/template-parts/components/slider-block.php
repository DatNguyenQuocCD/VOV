 ...
 */
if (!function_exists('boundlessnews_slider_blocks')):
    function boundlessnews_slider_blocks($boundlessnews_home_section, $repeat_times)
    {
        ...
        if ($carousel_post_query->have_posts()): ?>
            <div id="theme-block-<?php echo esc_attr($repeat_times); ?>" class="theme-block theme-block-slider">
                <div class="theme-banner-default" data-slick='{"autoplay": <?php echo esc_attr($autoplay); ?>, "rtl": <?php echo esc_attr($rtl); ?>}'>
                ...
                <div class="slider-navigator slider-navigator-default">
                    <div class="wrapper">
                        <div class="theme-slider-navigator theme-default-slicknav theme-carousel-space" data-slick='{"autoplay": <?php echo esc_attr($autoplay); ?>, "dots": false, "rtl": <?php echo esc_attr($rtl); ?>}'>
                            <?php 
                            $i = 1;
