...
if ( !function_exists('boundlessnews_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function boundlessnews_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('BoundlessNews_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'boundlessnews_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('BoundlessNews_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class BoundlessNews_Tab_Posts_Widget extends BoundlessNews_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'boundlessnews_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'boundlessnews'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'boundlessnews'),
                    'type'           => 'heading',
                ),
                'popular_title' => array(
                    'label' => esc_html__('Popular Tab Title', 'boundlessnews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'boundlessnews'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'boundlessnews'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'boundlessnews'),
                    'type'              => 'checkbox',
                    'default'           => true,
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'boundlessnews'),
                    'description'   => esc_html__('Number of words', 'boundlessnews'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'boundlessnews'),
                    'type'          => 'heading',
                ),
                'recent_title' => array(
                    'label' => esc_html__('Recent Tab Title', 'boundlessnews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'boundlessnews'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'boundlessnews'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'boundlessnews'),
                    'type'            => 'heading',
                ),
                'comment_title' => array(
                    'label' => esc_html__('Comment Tab Title', 'boundlessnews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'boundlessnews'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'boundlessnews'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'boundlessnews-tabbed', esc_html__( 'BoundlessNews: Sidebar Tab Widget', 'boundlessnews' ), $opts, array(), $fields );
