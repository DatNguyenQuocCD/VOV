...
if ( !function_exists('boundlessnews_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function boundlessnews_category_widgets(){
        // Recent Post widget.
        register_widget('BoundlessNews_Sidebar_Category_Widget');

    }

endif;
add_action('widgets_init', 'boundlessnews_category_widgets');

// Recent Post widget
if ( !class_exists('BoundlessNews_Sidebar_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class BoundlessNews_Sidebar_Category_Widget extends BoundlessNews_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'boundlessnews_category_widget',
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'boundlessnews'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'boundlessnews'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_title' => array(
                    'label' => esc_html__('Latest Text Label:', 'boundlessnews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Latest :', 'boundlessnews'),
                ),
            );

            parent::__construct('boundlessnews-category-layout', esc_html__('BoundlessNews: Sidebar Category Widget', 'boundlessnews'), $opts, array(), $fields);
        }
                        ...
                        foreach( $slug_counts as $key => $slug_count ){
                            ...
                            <li>
                                <article class="article-list">
                                    ...
                                    <header class="category-widget-header clear">
