...
function hello_fashion_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        new Vilva_Toggle_Control( 
            ...
            array(
                'section'       => 'typography_settings',
                'label'         => __( 'Load Google Fonts Locally', 'hello-fashion' ),
                'description'   => __( 'Enable to load google fonts from your own server instead from google\'s CDN. This solves privacy concerns with Google\'s CDN and their sometimes less-than-transparent policies.', 'hello-fashion' )
            )
        )
    );   
    ...
    $wp_customize->add_control(
        new Vilva_Toggle_Control( 
            ...
            array(
                'section'       => 'typography_settings',
                'label'         => __( 'Preload Local Fonts', 'hello-fashion' ),
                'description'   => __( 'Preloading Google fonts will speed up your website speed.', 'hello-fashion' ),
    ...
    ob_start(); ?>
        ...
        <span style="margin-bottom: 5px;display: block;"><?php esc_html_e( 'Click the button to reset the local fonts cache', 'hello-fashion' ); ?></span>
        
        <input type="button" class="button button-primary vilva-flush-local-fonts-button" name="vilva-flush-local-fonts-button" value="<?php esc_attr_e( 'Flush Local Font Files', 'hello-fashion' ); ?>" />
    <?php
    $hello_fashion_flush_button = ob_get_clean();
    ...
    $wp_customize->add_control(
        'ed_flush_local_fonts',
        array(
            'label'         => __( 'Flush Local Fonts Cache', 'hello-fashion' ),
            'section'       => 'typography_settings',
            'description'   => $hello_fashion_flush_button,
            'type'          => 'hidden',
            'active_callback' => 'vilva_ed_localgoogle_fonts'
        )
    );
