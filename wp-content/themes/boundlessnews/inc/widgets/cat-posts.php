 ...
 */
if (!function_exists('boundlessnews_category_post_widgets')) :
     ...
     * @since 1.0.0
     */
    function boundlessnews_category_post_widgets()
    {

        // Category Post widget.
        register_widget('BoundlessNews_Sidebar_Category_Posts_Widget');

    }

endif;

add_action('widgets_init', 'boundlessnews_category_post_widgets');

// Category Post widget
if (!class_exists('BoundlessNews_Sidebar_Category_Posts_Widget')) :
    ...
    class BoundlessNews_Sidebar_Category_Posts_Widget extends BoundlessNews_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $opts = array(
                'classname' => 'boundlessnews_category_post_widget',
            ...
            $fields = array(
                'title_1' => array(
                    ...
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Category 1', 'boundlessnews'),
                ),
                ...
                'title_2' => array(
                    ...
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Category 2', 'boundlessnews'),
                ),
                ...
                'title_3' => array(
                    ...
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Category 3', 'boundlessnews'),
                ),
            ...
            parent::__construct('BoundlessNews-category-posts', esc_html__('BoundlessNews: Layout Multiple Panel', 'boundlessnews'), $opts, array(), $fields);
                                ...
                                <div class="widget-column widget-column-<?php echo $column_class; ?> widget-column-sm-12">
                                    ...
                                    while ($category_post_query->have_posts()) {
                                        ...
                                        if ($post_count == 1) {
                                            ...
                                            $featured_image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'boundlessnews-550-400');
