 ...
 */
if ( !function_exists('boundlessnews_tiles_post_widgets') ) :
     ...
     * @since 1.0.0
     */
    function boundlessnews_tiles_post_widgets(){

        // Tiles Post widget.
        register_widget('BoundlessNews_Sidebar_Tiles_Posts_Widget');

    }

endif;

add_action('widgets_init', 'boundlessnews_tiles_post_widgets');

// Tiles Post widget
if ( !class_exists('BoundlessNews_Sidebar_Tiles_Posts_Widget') ) :
    ...
    class BoundlessNews_Sidebar_Tiles_Posts_Widget extends BoundlessNews_Widget_Base{
        ...
        function __construct(){
            ...
            $opts = array(
                'classname' => 'boundlessnews_tiles_post_widget',
            ...
            parent::__construct( 'BoundlessNews-tiles-1-posts', esc_html__('BoundlessNews: Layout Tiles', 'boundlessnews'), $opts, array(), $fields );
