(function ($) {
    ...
    var ajaxurl = boundlessnews_admin.ajax_url;
    var boundlessnewsNonce = boundlessnews_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#boundlessnews-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: boundlessnews_admin.upload_image,
            button: {
            text: boundlessnews_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'boundlessnews_notice_dismiss',
            '_wpnonce': boundlessnewsNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-boundlessnews-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-boundlessnews-notice').addClass('twp-installing');

        var data = {
            'action': 'boundlessnews_install_plugins',
            '_wpnonce': boundlessnewsNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = boundlessnews_admin.active
            var deactivate = boundlessnews_admin.deactivate
