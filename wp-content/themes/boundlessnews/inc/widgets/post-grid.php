 ...
 */
if (!function_exists('boundlessnews_grid_post_widgets')) :
     ...
     * @since 1.0.0
     */
    function boundlessnews_grid_post_widgets()
    {

        // Grid Post widget.
        register_widget('BoundlessNews_Sidebar_Grid_Posts_Widget');

    }

endif;

add_action('widgets_init', 'boundlessnews_grid_post_widgets');

// Grid Post widget
if (!class_exists('BoundlessNews_Sidebar_Grid_Posts_Widget')) :
    ...
    class BoundlessNews_Sidebar_Grid_Posts_Widget extends BoundlessNews_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $opts = array(
                'classname' => 'boundlessnews_grid_post_widget',
            ...
            $fields = array(
                ...
                'column_number' => array(
                    ...
                    'options' => array(
                        ...
                        '4' => esc_html__('4', 'boundlessnews'),
                    ),

                ),
            );

            parent::__construct('BoundlessNews-grid-1-posts', esc_html__('BoundlessNews: Layout Grid', 'boundlessnews'), $opts, array(), $fields);
                    ...
                    <div class="widget-row">
                        ...
                        if ($grid_post_query->have_posts()):
                            ...
                            while ($grid_post_query->have_posts()) {
                                ...
                                $featured_image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'boundlessnews-400-280');
                                $featured_image = isset( $featured_image[0] ) ? $featured_image[0] : ''; ?>

                                <div class="widget-column widget-column-<?php echo $column_class; ?> widget-column-sm-6 widget-column-xs-12">
                                    <article id="theme-post-<?php the_ID(); ?>" <?php post_class('news-article mb-20 post-thumb'); ?>>
