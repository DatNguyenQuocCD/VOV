 ...
 */
if ( !function_exists('boundlessnews_carousel_post_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function boundlessnews_carousel_post_widgets(){
        // Carousel Post widget.
        register_widget('BoundlessNews_Sidebar_Carousel_Posts_Widget');
    }
endif;
add_action('widgets_init', 'boundlessnews_carousel_post_widgets');
// Carousel Post widget
if ( !class_exists('BoundlessNews_Sidebar_Carousel_Posts_Widget') ) :
    /**
     * Carousel Post.
     *
     * @since 1.0.0
     */
    class BoundlessNews_Sidebar_Carousel_Posts_Widget extends BoundlessNews_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'boundlessnews_carousel_post_widget',
            ...
            $fields = array(
                ...
                'slide_to_show' => array(
                    'label' => esc_html__('Slide to Show', 'boundlessnews'),
                    'type' => 'number',
                    'default' => 3,
                    'css' => 'max-width:60px;',
                    'min' => 1,
            ...
            parent::__construct( 'BoundlessNews-carousel-posts', esc_html__('BoundlessNews: Carousel Widget', 'boundlessnews'), $opts, array(), $fields );
        }
        /**
